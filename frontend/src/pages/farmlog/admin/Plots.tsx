...
const createPlotSchema = z.object({
  ...
  // Round V — no plotCode: the server always generates it
  // ({supplierCode}-{YYMM}-{running}), the same rule as the Auto Lot.
  name: z.string().min(1, 'กรุณาระบุชื่อแปลง').max(255),
  ...physicalPlotFields,
  ...cyclePlanFields,
          ...
          <div>
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              {/* Round V — the code is always generated, so this is a preview,
                  ...
                  running number it assigns on save. */}
              <Field label="รหัสแปลง">
                <div
                  aria-label="รหัสแปลง"
                ...
                >
                  ...
                  <span className="break-all font-mono">{plotCodePreview}</span>
                </div>
                <p className="text-xs text-muted-foreground">
                  ระบบสร้างให้อัตโนมัติ — เลขรันจริงกำหนดตอนบันทึก
                </p>
              </Field>
